...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://calebschafrath.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post",
    };
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://calebschafrath.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch",
      });
    }
  }
  ...
  buildForm() {
    ...
    formData.append("portfolio_blog[bolg_status]", this.state.blog_status);
    ...
    axios({
      ...
      .then((response) => {
        ...
        if (this.props.editMode) {
          ...
          this.props.handleSuccessfullFromSubmission(
